...
sess = tf.Session()
#加载数据 x0萼片长度，x1萼片宽度，x2花瓣长度，x3花瓣宽度
...
#print(np.transpose(y_vals_train))
batch_size = 100
...
#反向传播过程和loss函数 Loss = max(0, 1-pred*actual) + alpha * L2_norm(A)^2
...
for i in range(20000):
    ...
    if i%500==0:
        ...
        print("%d steps,train_loss: %g,test_loss: %g"%(i,train_loss,test_loss))
